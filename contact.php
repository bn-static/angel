...
<script>(function(d, s, id) {
  ...
  <div class="content">
  <h1 class="page-title lato text-center">Contact Us</h1>
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h2 class="lato">Online Form</h2>
          <form id="contact-form" action="https://fwdform.herokuapp.com/user/0fb70578-0aef-4735-83a8-a1e89b0f0aac" method="post">
        ...
        <div class="col-md-6">
          <h2 class="lato">Info</h2>
          <table class="table">
            <tr>
              <td>Address : </td>
              <td><address>No 25 (A), Dai Won Kwin, Chinatown , Dai Won Road, Bogyoke Street, Mawlamyaing, Myanmar</address></td>
            </tr>
            <tr>
              <td>Phone : </td>
              <td><tel>9595374226</tel>, <tel>095374226</tel>, <tel>0976967113</tel></td>
            </tr>
          </table>
        </div>
      </div>
